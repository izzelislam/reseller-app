                            ...
                            <div class="d-flex flex-column h-100 py-0 py-xl-3">
                                            ...
                                            <div class="p-lg-5 p-4">
                                                <div>
                                                    <div class="text-center mt-1">
                                                        <h4 class="font-size-18">Mendaftar Akun</h4>
                                                ...
                                                <div class="mt-4 text-center">
                                                    <p class="mb-0">Sudah mempunyai account ? <a href="{{ route('login') }}"
                                                            class="fw-medium text-primary"> Masuk</a> </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-5 text-center">
                                    <p class="mb-0">©
                                        ...
                                        </script> develop with <i
                                            class="mdi mdi-heart text-danger"></i> by bangfkr002@gmail.com
                                    </p>
                                </div>
                            </div>
                        </div>
