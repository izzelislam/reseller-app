...
<head>
  ...
  <!-- Stylesheets -->
  <link rel="stylesheet" href="/lp/assets/css/bootstrap.min.css" />
  <link rel="stylesheet" href="/lp/assets/css/owlCarousel.min.css" />
  <link rel="stylesheet" href="/lp/assets/css/fontawesome.min.css" />
  <link rel="stylesheet" href="/lp/assets/css/flaticon.css" />
...
<body>
      ...
      <div class="container">
        <div class="st-main-header-in">
          <div class="st-site-branding">
            <a href="#" class="st-logo-link"><img src="/lp/assets/img/light-img/logo.png" alt="demo"></a>
          </div>
          <!-- For Site Title -->
          ...
          <div class="st-nav-wrap st-fade-down">
            ...
            <nav class="st-nav st-desktop-nav">
              <ul class="st-nav-list onepage-nav">
                ...
                <li><a href="#service" class="smooth-scroll">Produk</a></li>
                <li><a href="#portfolio" class="smooth-scroll">Portfolio</a></li>
                <li><a href="#contact" class="smooth-scroll">Contact</a></li>
                @if (Auth::check())
                <li><a href="/home" class="smooth-scroll btn btn-primary text-white">Dashboard</a></li>
                @else
                <li><a href="/login" class="smooth-scroll btn btn-primary text-white">Masuk</a></li>
                @endif
              </ul>
            </nav><!-- .st-nav -->
          </div><!-- .st-nav-wrap -->
  ...
  <div class="st-content">
      ...
      <div class="st-hero-slide st-style1 st-flex">
        <div class="container">
          <div class="st-hero-text st-style1">
            <h1 class="st-hero-title">Bisnis Mudah <br />Tanpa Modal!</h1>
            <div class="st-hero-subtitle">
              kami menyediakan produk yang siap anda jual<br />
              tanpa memerlukan modal anda sudah bisa berjualan.
            </div>
            <div class="st-btn-group st-style1">
              <a href="{{ route('register') }}" class="st-btn st-style1 st-color1">Daftar</a>
        ...
        <div class="st-hero-img"><img src="/lp/assets/img/light-img/hero-img.png" alt="demo"></div>
      </div>
    </div>
    <!-- End Hero Slider -->
    <!-- Start Icon Box -->
          ...
          <div class="col-lg-6">
            <div class="st-vertical-middle">
              <div class="st-vertical-middle-in">
                <div class="st-about-img wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s"><img src="/lp/assets/img/light-img/about-img1.png" alt="demo"></div>
              </div>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="st-section-heading st-style1">
              <h3>About Us</h3>
              <h2>Kami adalah tim yang luar biasa untuk impian bisnis Anda</h2>
            </div>
    ...
    <section class="st-service-section st-section-top" id="service">
      <div class="container">
        <div class="st-section-heading st-style2 text-center">
          <h2>Cara Cepat Memulai</h2>
          <div class="st-seperator">
            <div class="st-seperator-left-bar wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
            <img src="/lp/assets/img/light-img/seperator-icon.png" alt="demo" class="st-seperator-icon">
            <div class="st-seperator-right-bar wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"></div>
          </div>
          <p>Anda bisa melakukannya dengan cepat dan mudah dengan kami membantu anda, <br> dengan melakukan beberapa langkah anda sudah bisa mendapatkan keuntungan.</p>
        </div>
      </div>
        ...
        <div class="container">
          <div class="st-service-carousel owl-carousel st-style2 st-owl-controler3">
            <div class="st-image-box st-style1 text-center wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s">
              <a href="#" class="st-image"><img src="/lp/assets/img/light-img/service1.png" alt="demo"></a>
              <div class="st-image-box-info">
                <h3 class="st-image-box-title"><a href="#">Mendaftar  Afiliator</a></h3>
                <div class="st-image-box-text">Dengan melakukan pendaftaran artinya anda sudah menjadi bagian dari kami.</div>
              </div>
            </div>
            <div class="st-image-box st-style1 text-center wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.25s">
              <a href="#" class="st-image"><img src="/lp/assets/img/light-img/service2.png" alt="demo"></a>
              <div class="st-image-box-info">
                <h3 class="st-image-box-title"><a href="#">Promosikan Produk</a></h3>
                <div class="st-image-box-text">Setelah Mendaftar anda perlu melakukan promosi dengan produk yang tersedia.</div>
              </div>
            </div>
            <div class="st-image-box st-style1 text-center wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.3s">
              <a href="#" class="st-image"><img src="/lp/assets/img/light-img/service3.png" alt="demo"></a>
              <div class="st-image-box-info">
                <h3 class="st-image-box-title"><a href="#">Dapatkan Komisi</a></h3>
                <div class="st-image-box-text">Setelah melakukan promosi dan terjual produknya anda akan mendapatkan komisi yang menarik.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-sm-6">
            <div class="st-funfact text-center wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
              ...
              <h2 class="st-funfact-number st-counter">{{ $total_reseller }}</h2>
              <h3 class="st-funfact-title">Reseller Terdaftar</h3>
            </div>
          </div>
          <div class="col-lg-4 col-sm-6">
            <div class="st-funfact text-center wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.25s">
              ...
              <h2 class="st-funfact-number st-counter">{{ $total_sales }}</h2>
              <h3 class="st-funfact-title">Produk Terjual</h3>
            </div>
          </div>
          <div class="col-lg-4 col-sm-6">
            <div class="st-funfact text-center wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
              ...
              <h2 class="st-funfact-number st-counter">{{ $total_products }}</h2>
              <h3 class="st-funfact-title">Produk Tersedia</h3>
            </div>
          </div>
    ...
    {{-- <div class="st-project-wrap st-section-top" id="portfolio">
      ...
      <div class="st-project st-project-carousel owl-carousel st-style1 st-owl-controler1">
        <a href="#" class="st-single-project st-bg wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s" data-src="/lp/assets/img/light-img/project1.jpg">
          <div class="st-project-meta">
            <h3>Project Title One</h3>
            <span>Branding</span>
          </div>
        </a>
        <a href="#" class="st-single-project st-bg wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.25s" data-src="/lp/assets/img/light-img/project2.jpg">
          <div class="st-project-meta">
            <h3>Project Title One</h3>
            <span>Branding</span>
          </div>
        </a>
        <a href="#" class="st-single-project st-bg wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.3s" data-src="/lp/assets/img/light-img/project3.jpg">
          <div class="st-project-meta">
            <h3>Project Title One</h3>
            <span>Branding</span>
          </div>
        </a>
        <a href="#" class="st-single-project st-bg wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.35s" data-src="/lp/assets/img/light-img/project4.jpg">
          <div class="st-project-meta">
            <h3>Project Title One</h3>
            <span>Branding</span>
          </div>
            ...
            <div class="st-vertical-middle">
              <div class="st-vertical-middle-in wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
                <div class="st-skill-img text-center">
                  <img src="/lp/assets/img/light-img/skill-img.png" alt="demo">
                </div>
              </div>
            </div>
          </div>
    ...
    <section class="st-team-wrap st-section" id="team">
      <div class="container">
        <div class="st-section-heading st-style2 text-center">
          ...
          <p>Produk yang tersedia dan siap anda jual  <br>Untuk mulai mendapatkan keuntungan.</p>
        </div>
      </div>
      <div class="st-owl-controler3-hover">
        <div class="container">
            ...
            @foreach ($products as $product)
              <div class="st-team-member text-center wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
                <div class="st-member-img">
                  <img src="{{ asset('storage/'.$product->image) }}" alt="demo">
                </div>
                <div class="st-member-info">
                  <h3 class="st-member-name">{{ $product->name }}</h3>
                  <div class="st-member-designation">{{ Str::limit($product->describtion, 50, '...') }}</div>
                </div>
              </div>
            @endforeach
        ...
        <div class="row">
          <div class="col-lg-7 offset-lg-1">
            <div class="st-cta text-center st-section">
              <h2 class="st-cta-title">Gas Mulai Sekarang, Sat Set Tunggu Apalagi!</h2>
              <div class="st-cta-text">kami akan membantu jika anda mengalami kesuliatan menggunakan layanan kami. dan kami pastikan anda akan mendapatkan keuntungan.</div>
              <div class="st-cta-btn">
                <a href="{{ route('register') }}" class="st-btn st-style1 st-size1 st-color1">Daftar Sekarang!</a>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="st-vertical-middle">
              <div class="st-vertical-middle-in st-flex">
                <div class="st-cta-img wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s">
                  <img src="/lp/assets/img/light-img/cta-img.png" alt="demo">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="st-price-card text-center wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
              <div class="st-price-card-img"><img src="/lp/assets/img/light-img/price-img1.png" alt="demo"></div>
          ...
          <div class="col-lg-4">
            <div class="st-price-card text-center st-featured-price wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
              <div class="st-price-card-img"><img src="/lp/assets/img/light-img/price-img2.png" alt="demo"></div>
          ...
          <div class="col-lg-4">
            <div class="st-price-card text-center wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
              <div class="st-price-card-img"><img src="/lp/assets/img/light-img/price-img3.png" alt="demo"></div>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="st-blog st-style1 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
              <div class="st-zoom">
                <a href="#" class="st-blog-thumb st-bg st-zoom-in" data-src="/lp/assets/img/light-img/blog1.png"></a>
              </div>
          ...
          <div class="col-lg-4">
            <div class="st-blog st-style1 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
              <div class="st-zoom">
                <a href="#" class="st-blog-thumb st-bg st-zoom-in" data-src="/lp/assets/img/light-img/blog2.png"></a>
              </div>
              <div class="st-blog-info">
                <div class="st-blog-label">By <a href="#">Limty</a></div>
          ...
          <div class="col-lg-4">
            <div class="st-blog st-style1 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
              <div class="st-zoom">
                <a href="#" class="st-blog-thumb st-bg st-zoom-in" data-src="/lp/assets/img/light-img/blog3.png"></a>
              </div>
              <div class="st-blog-info">
                <div class="st-blog-label">By <a href="#">Limty</a></div>
    ...
    {{-- <div class="st-client-wrap st-section">
      <div class="container">
        <div class="st-client-carousel owl-carousel">
          <div class="st-client-logo st-flex wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s"><img src="/lp/assets/img/light-img/client-logo01.png" alt="demo"></div>
          <div class="st-client-logo st-flex wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.25s"><img src="/lp/assets/img/light-img/client-logo02.png" alt="demo"></div>
          <div class="st-client-logo st-flex wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.3s"><img src="/lp/assets/img/light-img/client-logo03.png" alt="demo"></div>
          <div class="st-client-logo st-flex wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.35s"><img src="/lp/assets/img/light-img/client-logo04.png" alt="demo"></div>
          <div class="st-client-logo st-flex wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.4s"><img src="/lp/assets/img/light-img/client-logo05.png" alt="demo"></div>
        </div>
      </div>
    </div> --}}
    <!-- End Client Section -->
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="st-testimonial-right-img st-flex wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
              <img src="/lp/assets/img/light-img/testimonial-img.png" alt="demo">
            </div>
          </div>
          <div class="col-lg-6">
            <div class="st-vertical-middle">
            ...
            <div class="st-newsletter-wrap">
              ...
              <div class="st-right-newsletter">
                <div class="st-newsletter-img wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
                  <img src="/lp/assets/img/light-img/news-letter-img.png" alt="demo">
                  <div class="st-bard-animation">
                    <div class="st-bard-animation1"><img src="/lp/assets/img/light-img/bard1.png" alt="demo"></div>
                    <div class="st-bard-animation2"><img src="/lp/assets/img/light-img/bard2.png" alt="demo"></div>
                    <div class="st-bard-animation3"><img src="/lp/assets/img/light-img/bard3.png" alt="demo"></div>
                  </div>
                </div>
              </div>
            </div>
    ...
    <section class="st-contact-wrap st-gray-bg st-section" id="contact">
      <div class="container">
        <div class="st-section-heading st-style2 text-center">
          ...
          <p>Jika anda mempunyai pertanyaan, silahkan hubungi kami lebih lanjut</p>
        </div>
      </div>
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div id="cf-msg"></div>
            <form action="/lp/assets/php/mail.php" method="post" class="st-contact-form" id="cf">
          ...
          <div class="col-lg-6">
            <div class="st-contact-info st-style1">
              <div class="st-contact-info-in">
                ...
                <div class="st-contact-info-text">Kontak adalah bagian terpenting dalam bisnis. Jika Anda memerlukan informasi tentang bisnis kami, hubungi informasi yang tersedia di bawah ini</div>
                <h3 class="st-contact-info-title">{{ $setting->company_name }}</h3>
                <ul>
                  <li><i class="fas fa-map-signs"></i>{{ $setting->company_address ?? '' }}</li>
                  <li><i class="fas fa-phone"></i>{{ $setting->company_phone }}</li>
    ...
    {{-- <div class="st-map-wrap">
      <div class="st-map-bar st-flex">
        <div class="st-map-bar-img">
          <img src="/lp/assets/img/light-img/map-icon-img.png" alt="demo">
    ...
    <div class="st-main-footer text-center">
      <div class="container">
        <div class="st-footer-logo">
          <img src="/lp/assets/img/light-img/footer-logo.png" alt="demo">
        </div>
  ...
  <!-- End Video Popup -->
  <!-- Scripts -->
  <script src="/lp/assets/js/vendor/modernizr-3.5.0.min.js"></script>
  <script src="/lp/assets/js/vendor/jquery-1.12.4.min.js"></script>
  <script src="/lp/assets/js/mailchimp.min.js"></script>
  <script src="/lp/assets/js/owlCarousel.min.js"></script>
  <script src="/lp/assets/js/tamjid-counter.min.js"></script>
